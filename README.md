...
All data and changes in this repository are simulated in the browser. A client
implementation requires the Firebase backend, authentication, security rules,
deployment configuration, and client-owned account details.
